...
const badStateSets = ({
    ...
    // 三点
    "乳首敏感(左)": [
        {level: "Lv.1",      sensitivity: {leftNipple:   5}, sensation: 0.5},
        {level: "Lv.2",      sensitivity: {leftNipple:  10}, sensation: 0.5},
    ...
    "乳首敏感(右)": [
        ...
        {level: "Lv.2",      sensitivity: {rightNipple:  10}, sensation: 0.5},
    ...
    クリ敏感: [
        ...
        {level: "Lv.2",    sensitivity: {clitoris:  10}, sensation: 0.5},
    ...
    "露出の呪い(上)": [
        ...
        {name: "服乳首上2cm" , sensation: 0.3, sensitivity: {skin: 10, bust:  3, leftNipple:  3, rightNipple:  3}, cycle: 4000, retryDown: 1, trigger: ["露出快感"]},
        {name: "服乳首上0cm" , sensation:   1, sensitivity: {skin: 20, bust:  5, leftNipple: 15, rightNipple: 15}, cycle: 4000, retryDown: 1, trigger: ["露出快感", "露出快感", "露出快感"]},
        {name: "服乳首下3cm" , sensation:   1, sensitivity: {skin: 30, bust: 10, leftNipple: 25, rightNipple: 25}, cycle: 4000, retryDown: 1, trigger: ["露出快感", "露出快感", "露出快感"]},
    ...
    "露出の呪い(下)": [
        ...
        {name: "スカート股下3cm" , sensation: 0.3, sensitivity: {skin: 10, urethra: 20, clitoris: 20, vagina: 20, anal: 20, hip: 10}, cycle: 4000, retryDown: 1, trigger: ["露出快感", "露出快感", "露出快感"]},
        {name: "スカート股下0cm" , sensation:   1, sensitivity: {skin: 20, urethra: 30, clitoris: 30, vagina: 30, anal: 30, hip: 20}, cycle: 4000, retryDown: 1, trigger: ["露出快感", "露出快感", "露出快感"]},
        {name: "スカート股上3cm" , sensation: 1.5, sensitivity: {skin: 30, urethra: 40, clitoris: 40, vagina: 40, anal: 40, hip: 25}, cycle: 4000, retryDown: 1, trigger: ["露出快感", "露出快感", "露出快感", "露出快感"]},
