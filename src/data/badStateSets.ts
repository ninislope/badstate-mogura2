...
const badStateSets = ({
    ...
    絶頂余韻: [ // [特殊]: 絶頂時に自動付与
        ...
        ...Array.from({length: 499}, (_, index) =>
            ({level: `Lv.${index + 2}`, sensitivity: {vagina: 25 + index * 5, womb: 25 + index * 5}, delay: 100 + index * 10, period: Math.max(500 - index * 5, 100), retryDown: true}), // 最大28秒ほど
        ),
    ],
    屈服絶頂余韻: [ // [特殊]: 屈服絶頂時に自動付与
    ...
    ,*/
    連続絶頂体質: [ // [特殊]: 絶頂回数で誘発 このバステがある場合絶頂後に完全に快感が回復しない 進行度 * 20%の快感が残留する
    ...
    子宮屈服: [ // [特殊]: 絶頂回数で誘発 このバステがある場合絶頂後のステートに屈服絶頂余韻が追加
        {countActivate: [{name: "絶頂", count: 500}], description: "絶頂で動けなくなってしまう"},
    ],

    // 汎用
    膣内射精: [
        {sensation: 4, sensitivity: {vagina: 20, womb: 20}, delay: 400, stop: 1000, prod: 100, period: 4000, stageDown: 1, speak: ["いやぁぁぁぁぁっ♡"]},
    ],
    発情: [
    ...
    // 三点
    "乳首敏感(左)": [
        {level: "Lv.1",   sensitivity: {leftNipple:   5}},
        {level: "Lv.2",   sensitivity: {leftNipple:  10}},
        {level: "Lv.3",   sensitivity: {leftNipple:  20}},
        {level: "Lv.4",   sensitivity: {leftNipple:  40}},
        {level: "Lv.Max", sensitivity: {leftNipple: 100}},
        {name: "左乳首弄り", sensitivity: {leftNipple: 100}, sensation: 1, stop: 250, period: 250, stageDown: 1, speak: ["ひゃぁんっ♡"], hideSpeed: 50},
    ],
    "乳首敏感(右)": [
        {level: "Lv.1",   sensitivity: {rightNipple:   5}},
        {level: "Lv.2",   sensitivity: {rightNipple:  10}},
        {level: "Lv.3",   sensitivity: {rightNipple:  20}},
        {level: "Lv.4",   sensitivity: {rightNipple:  40}},
        {level: "Lv.Max", sensitivity: {rightNipple: 100}},
        {name: "右乳首弄り", sensitivity: {rightNipple: 100}, sensation: 1, stop: 250, period: 250, stageDown: 1, speak: ["ひゃぁんっ♡"], hideSpeed: 50},
    ],
    クリ敏感: [
        {level: "Lv.1",   sensitivity: {clitoris:   5}},
        {level: "Lv.2",   sensitivity: {clitoris:  10}},
        {level: "Lv.3",   sensitivity: {clitoris:  20}},
        {level: "Lv.4",   sensitivity: {clitoris:  40}},
        {level: "Lv.Max", sensitivity: {clitoris: 100}},
        {name: "クリ弄り", sensitivity: {clitoris: 100}, sensation: 1, stop: 250, period: 250, stageDown: 1, speak: ["ひゃぁんっ♡"], hideSpeed: 50},
    ],
    "乳首肥大化(左)": [
        {level: "Lv.1",   sensitivity: {leftNipple:  5},  delay: 50},
        {level: "Lv.2",   sensitivity: {leftNipple: 10},  delay: 100},
        {level: "Lv.3",   sensitivity: {leftNipple: 20},  delay: 150},
        {level: "Lv.4",   sensitivity: {leftNipple: 40},  delay: 200, sensation:   1, stop:  80, cycle: 7000, prod: 20, speak: ["やっ……乳首……っ"]},
        {level: "Lv.Max", sensitivity: {leftNipple: 100}, delay: 250, sensation: 1.5, stop: 120, cycle: 6000, prod: 50, speak: ["乳首擦れちゃ……っ"]},
    ],
    "乳首肥大化(右)": [
        {level: "Lv.1",   sensitivity: {rightNipple:  5},  delay: 50},
        {level: "Lv.2",   sensitivity: {rightNipple: 10},  delay: 100},
        {level: "Lv.3",   sensitivity: {rightNipple: 20},  delay: 150},
        {level: "Lv.4",   sensitivity: {rightNipple: 40},  delay: 200, sensation:   1, stop:  80, cycle: 7000, prod: 20, speak: ["やっ……乳首……っ"]},
        {level: "Lv.Max", sensitivity: {rightNipple: 100}, delay: 250, sensation: 1.5, stop: 120, cycle: 6000, prod: 50, speak: ["乳首擦れちゃ……っ"]},
    ],
    クリ肥大化: [
        {level: "Lv.1",   sensitivity: {clitoris:   5}, delay:  30},
        {level: "Lv.2",   sensitivity: {clitoris:  10}, delay:  60},
        {level: "Lv.3",   sensitivity: {clitoris:  20}, delay:  90},
        {level: "Lv.4",   sensitivity: {clitoris:  40}, delay: 120, sensation:   1, stop:  80, cycle: 8000, prod: 20, speak: ["あっクリ……"]},
        {level: "Lv.Max", sensitivity: {clitoris: 100}, delay: 150, sensation: 1.5, stop: 120, cycle: 6000, prod: 50, speak: ["クリだめ……っ"]},
    ],
    乳首ローター: [
    ...
    // おっぱい
    膨乳: [
        {level: "Cカップ", sensitivity: {bust: 3}, delay: 10},
        {level: "Dカップ", sensitivity: {bust: 6}, delay: 50},
        {level: "Eカップ", sensitivity: {bust: 10}, delay: 80},
        {level: "Fカップ", sensitivity: {bust: 15}, delay: 150},
        {level: "Gカップ", sensitivity: {bust: 30}, delay: 250},
        {level: "Hカップ", sensitivity: {bust: 50}, delay: 300},
        {level: "Iカップ", sensitivity: {bust: 100}, delay: 360},
        {level: "Jカップ", sensitivity: {bust: 160}, delay: 360},
        {level: "Kカップ", sensitivity: {bust: 240}, delay: 360},
        {level: "Lカップ", sensitivity: {bust: 320}, delay: 360},
    ],
    母乳体質: [
    ...
    おもらし: [
        ...
        {level: ""       , sensation: 2, sensitivity: {urethra: 100}, delay: 400, period: 4000, periodDown: true, stageDown: true, count: 1, trigger: ["おもらし癖", "尿道性感"]},
    ],
    尿道性感: [ // おもらし回数で誘発
    ...
    露出性感: [ // 露出回数で誘発
        ...
        {level: "(中度)", sensitivity: {skin: 150, bust:  70, leftNipple:  70, rightNipple:  70, urethra:  70, clitoris:  70, vagina:  70, anal:  70, hip: 40}, count: 1, countActivate: [{name: "露出性感", count: 100}], description: "露出の快感が頭から離れなくなってしまう"},
        {level: "(重度)", sensitivity: {skin: 200, bust: 100, leftNipple: 100, rightNipple: 100, urethra: 100, clitoris: 100, vagina: 100, anal: 100, hip: 60}, count: 1, countActivate: [{name: "露出性感", count: 500}], description: "露出を抑えられなくなってしまう"},
    ],
...
type BadStateSetName = keyof typeof badStateSets;
